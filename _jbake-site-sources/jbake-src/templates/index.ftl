<#include "header.ftl">
	...
	-->
	 ...
	 <div class="jumbotron">
        ...
        <p class="lead"><strong>Build your projects</strong> by editing Java code only. <strong>Drop XML and build scripts</strong> in favor of your favorite language and enjoy.<p/>
        <p class="lead">Jerkar brings unrivaled <strong>ease</strong>, <strong>flexibility</strong>, <strong>lightness</strong> and 
        ...
        <div class="container nopad">
	        <div class="alert alert-info col-md-7">
				...
				2016-03-16 : New release 0.4.0 <a href="https://github.com/jerkar/jerkar/releases"> is out !</a> <br/>
			...
			<div class="alert alert-info col-md-4">
				...
				Jerkar is a young project, as such there's plenty of free rooms for new comers.  <br/>
				Also, to gain consideration Jerkar needs a growing community. Please <a href="https://github.com/jerkar/jerkar">visit the the GitHub page</a>.
			</div>
		</div>
      </div>
