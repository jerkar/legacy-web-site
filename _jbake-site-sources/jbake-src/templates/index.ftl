<#include "header.ftl">
	...
	-->
	 ...
	 <div class="jumbotron">
        ...
        <p class="lead"><strong>Build your Java projects</strong> by editing Java only. <strong>Drop XML and build scripts</strong> in favor of your favorite language and enjoy.<p/>
