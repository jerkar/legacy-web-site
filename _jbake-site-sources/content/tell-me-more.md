...
* full dependency management to compile "scripts" : script dependencies can be made on Maven repositories, local jars or external projects
...
With Jerkar, build script are plain old java class. This bare metal approach leads in tremendous benefits :
...
Jerkar scripts reveals to be much more concise then their equivalent XML based tool and roughly equivalent to script written with dynamic languages.
